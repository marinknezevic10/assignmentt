<?php  $this->view("template/header", $data); ?>
      ...
      <main role="main">
        ...
        <section>
            <a href="<?= $data['prev_page']; ?>"><input type="button" class="s-12 submit-form button background-primary text-white" style="width:200px;" value="Previous page"></a>
            <a href="<?= $data['next_page']; ?>"><input type="button" class="s-12 submit-form button background-primary text-white" style="width:200px; float:right;" value="Next page"></a>
        </section>
      </main>
